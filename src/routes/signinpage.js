      ...
      <div class="ml-80 pl-20">
        ...
        <div class="ml-40 pl-8 pt-7">
          <div>
            <button
              type="button"
              class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-1 focus:outline-none focus:ring-white font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-5 mb-2"
            >
              <svg
                class="w-20 h-4 mr-2"
                aria-hidden="true"
          ...
          <div class="mt-2">
            <button
              type="button"
              class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-1 focus:outline-none focus:ring-white font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
                class="w-20 h-4 mr-1"
                aria-hidden="true"
        ...
        <div class="pl-16 ml-20 mt-4 text-white">
          ----------------------------------------------------------------{" "}
        </div>
        <div class="ml-49 pl-60 mt-3 text-sm text-white">
          ...
          <a
            href="#"
            class="font-medium text-white underline  hover:text-green-400"
          >
            Log in here
          </a>
        </div>
        ...
        <div class="ml-5 pl-20 mt-2 pt-4 text-white text-sm">
          ...
          <a
            href="#"
            class="font-medium text-white  underline  text-sm hover:text-red-400"
          >
            {" "}
